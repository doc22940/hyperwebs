  ...
  <DefaultLayout title='Home'>
    ...
    <Box py={[32, 64]} px={[32, 64, null, 128]} css={{background: 'white'}}>
      ...
      <Text is='p' width={[1, 3 / 4, 2 / 3]}>
        I operate a remote freelance design practice out of London, England (in addition to being <a href='https://colepeters.com'>a&nbsp;photographer</a>). Interested in working together? <Link href='/hire'><a tabIndex='0'>Get&nbsp;in&nbsp;touch</a></Link>.
      </Text>
    </Box>
